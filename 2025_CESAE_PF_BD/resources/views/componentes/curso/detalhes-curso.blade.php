                     ...
                     <div class="row g-3 mb-3">
                         <div class="col">
                             ...
                             <input type="date" class="form-control" id="data_inicio" name="data_inicio"
                                 value="{{ $curso->dataInicio }}" readonly>
                         </div>
                         <div class="col">
                             <label for="data_fim" class="form-label">Data fim</label>
                             <input type="date" class="form-control" id="data_fim" name="data_fim"
                                 value="{{ $curso->dataFim }}" readonly>
                         </div>
                     </div>
                     <div class="row g-3 mb-3">
                         <div class="col">
                             ...
                             <input type="text" class="form-control" id="total_horas" name="total_horas"
                                 value="{{ $duracaoFormatada }}" readonly>
                         </div>
                         <div class="col">
                             ...
                             <div class="input-group">
                                 <input type="text" class="form-control" id="preco_hora" name="preco_hora"
                                     value="{{ $curso->precoHora }}" readonly>
                     ...
                     <div class="row g-3 mb-3">
                         ...
                         <div class="col-md-4 d-flex flex-column justify-content-start gap-2 btn-adicionar ">
                             <a href="" class="btn btn-novo-curso"><i class="bi bi-people-fill"></i> Ver
                                 Alunos</a>
                             <a href="" class="btn btn-novo-curso"><i class="bi bi-journal-bookmark-fill"></i>
                                 Ver Módulos</a>
                         </div>
                     </div>
