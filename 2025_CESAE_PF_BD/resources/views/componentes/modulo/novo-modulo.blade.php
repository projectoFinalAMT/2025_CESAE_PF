<div class="modal fade" id="novoModuloModal" tabindex="-1" aria-labelledby="novoModuloModalLabel"
                aria-hidden="true">
                                ...
                                <div class="row g-3 mb-3 justify-content-between">
                                    ...
                                    <div
                                        ...
                                        <button type="button" class="btn btn-novo-curso"><i
                                                class="bi bi-file-earmark-text-fill"></i> Adicionar Documentos</button>
                                    </div>
                                </div>
